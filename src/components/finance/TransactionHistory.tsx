...
>(
    (
        ...
        const generatePageNumbers = useMemo(() => {
            ...
            if (!Number.isInteger(totalPages) || totalPages < 0 || !Number.isInteger(page) || page < 1) {
            ...
            <Card sx={{ borderRadius: 2, boxShadow: 3, overflowX: "auto" }}>
                <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
                    ...
                    <Grid container spacing={1.5} sx={{ mb: 2 }}>
                        ...
                        <Grid size={{ xs: 6, sm: 4, md: 2 }}>
                            <FormControl
                                fullWidth
                                size={isMobile ? "small" : "medium"}
                                disabled={filters.period === "today" || filters.period === "yesterday"}
                                sx={{ "& .MuiInputBase-root": { fontSize: { xs: "0.875rem", sm: "1rem" } } }}
                            >
                                ...
                                <Select
                                    ...
                                    label="Month"
                                    disabled={loading || filters.period === "today" || filters.period === "yesterday"}
                    ...
                    {isMobile ? (
                        <Box>
                            {finances.length === 0 ? (
                                <Typography sx={{ textAlign: "center", py: 2, fontSize: { xs: "0.875rem", sm: "1rem" } }}>
                                    No transactions found
                                </Typography>
                            ) : (
                                finances.map((finance) => {
                                    const category = categories.find((cat) => cat.id === finance.category);
                                    return (
                                        <Card
                                            key={finance.id}
                                            sx={{
                                            ...
                                            <CardContent sx={{ p: 2 }}>
                                                ...
                                                >
                                                    ...
                                                    <Stack direction="row" spacing={1}>
                                                        <IconButton
                                                            onClick={() => {
                                                                console.log("Finance khi click Edit (mobile):", finance);
                                                                handleEdit(finance);
                                                            }}
                                                            disabled={loading}
                                                ...
                                                >
                                                    <strong>Amount:</strong> {finance.amount.toLocaleString("vi-VN")} VND
                                                </Typography>
                                                <Typography
                                                    variant="body2"
                                                ...
                                                <Typography
                                                    ...
                                                    sx={{ fontSize: { xs: "0.75rem", sm: "0.875rem" } }}
                                                >
                                                    <strong>Description:</strong> {finance.description || "-"}
                                                </Typography>
                                                <Typography
                                                    variant="body2"
                                                    sx={{ fontSize: { xs: "0.75rem", sm: "0.875rem" } }}
                                ...
                                {finances.map((finance) => {
                                    ...
                                    return (
                                        <TableRow key={finance.id}>
                                            ...
                                            <TableCell>{finance.amount.toLocaleString("vi-VN")} VND</TableCell>
                                            ...
                                            <TableCell align="right">
                                                <IconButton
                                                    onClick={() => {
                                                        console.log("Finance khi click Edit (desktop):", finance);
                                                        handleEdit(finance);
                                                    }}
                                                    disabled={loading}
                                                    aria-label={`Edit transaction ${finance.id}`}
                                ...
                                typeof pageNum === "string" ? (
                                    ...
                                    <Button
                                        ...
                                        sx={{
                                            ...
                                            fontSize: { xs: "0.75rem", sm: "0.875rem" },
                                            bgcolor: pageNum === pagination.page ? "primary.main" : "transparent",
                                            color: pageNum === pagination.page ? "white" : "text.primary",
                                            "&:hover": {
                                                bgcolor: pageNum === pagination.page ? "primary.dark" : "grey.100",
                                            },
                                        }}
