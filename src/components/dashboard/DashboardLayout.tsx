        ...
        >
            <Card
                sx={{
                    ...
                    minHeight: { xs: "150px", sm: "200px", md: "250px" }, // Consistent height for HeroAdmin
                }}
            >
                <HeroAdmin />
            </Card>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                    <Card
                        sx={{
                            borderRadius: "24px",
                            overflow: "hidden",
                            background: "linear-gradient(135deg, #2e003e, #3d2352, #1b1b2f)", // Cool blue gradient
                            boxShadow: "0 4px 20px rgba(0, 0, 0, 0.1)",
                            minHeight: { xs: "300px", sm: "350px", md: "400px" }, // Consistent height
                            display: "flex",
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                    <Card
                        sx={{
                            borderRadius: "24px",
                            overflow: "hidden",
                            background: "linear-gradient(135deg, #0f2027, #203a43, #2c5364)", // Cool teal gradient
                            boxShadow: "0 4px 20px rgba(0, 0, 0, 0.1)",
                            minHeight: { xs: "300px", sm: "350px", md: "400px" }, // Consistent height
                            display: "flex",
                            flexDirection: "column",
                ...
                <Grid size={{ xs: 12, md: 4 }}>
                    <Card
                        sx={{
                            borderRadius: "24px",
                            overflow: "hidden",
                            background: "linear-gradient(135deg, #2c3e50 0%, #34495e 100%)", // Cool dark blue-gray gradient
                            boxShadow: "0 4px 20px rgba(0, 0, 0, 0.1)",
                            minHeight: { xs: "300px", sm: "350px", md: "400px" }, // Consistent height
                            display: "flex",
                            flexDirection: "column",
                ...
                <Grid size={{ xs: 12, md: 8 }}>
                    <Card
                        sx={{
                            borderRadius: "24px",
                            overflow: "hidden",
                            background: "linear-gradient(135deg, #5e35b1 0%, #4527a0 100%)", // Cool purple gradient
                            boxShadow: "0 4px 20px rgba(0, 0, 0, 0.1)",
                            minHeight: { xs: "300px", sm: "350px", md: "400px" }, // Consistent height
                            display: "flex",
                            flexDirection: "column",
                    ...
                    >
                        <MustToDo
                            todos={todos}
                            statuses={statuses}
                            categories={todoCategories} // Fixed to use todoCategories
                            loading={isLoading}
